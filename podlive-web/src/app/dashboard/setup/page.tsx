...
export default function SetupPage() {
  ...
  const [formData, setFormData] = useState({ title: "", description: "", category: "Technology", visibility: "public", brand_color: "#7C3AED", audience_mode: "everyone", chat_enabled: true, moderation_enabled: true, low_latency: true, studio_config: { layout: "speaker", reactions: true, questions: true, polls: true, guestRequests: true } });
